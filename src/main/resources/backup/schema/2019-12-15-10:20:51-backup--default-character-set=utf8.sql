...
CREATE TABLE `info_room` (
  ...
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=44013 DEFAULT CHARSET=utf8 COLLATE=utf8_unicode_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
INSERT INTO `info_room` VALUES (44012,'豪华间/高级间',100,'110','....','IPTV',4,2,'单间','有',101);
...
) ENGINE=InnoDB AUTO_INCREMENT=44037 DEFAULT CHARSET=utf8 COLLATE=utf8_unicode_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
INSERT INTO `standard_room` VALUES (44002,'豪华间/高级间','二楼',2323,'无',101),(44007,'单身人间','二楼',222,'2222',102),(44035,'标准间','二楼',150,'无',104),(44036,'豪华间/高级间','二楼',150,'无',103);
...
-- Dump completed on 2019-12-15 22:20:51
