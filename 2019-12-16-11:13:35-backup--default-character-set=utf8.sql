...
CREATE TABLE `info_room` (
  ...
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=44022 DEFAULT CHARSET=utf8 COLLATE=utf8_unicode_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
INSERT INTO `info_room` VALUES (44017,'单人间',1212,'212','1212','IPTV',2121,121,'单间','有',105),(44019,'标准间',2121,'1212','无','IPTV',2121,1212,'单间','有',104),(44020,'标准间',1212,'1221','1212','IPTV',21212,1212,'单间','有',106),(44021,'标准间',121,'1212','1212','IPTV',12,212,'单间','无',103);
...
) ENGINE=InnoDB AUTO_INCREMENT=44041 DEFAULT CHARSET=utf8 COLLATE=utf8_unicode_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
INSERT INTO `standard_room` VALUES (44035,'标准间','二楼',150,'无',104),(44038,'标准间','二楼',12,'1212',103),(44039,'单人间','一楼',1212,'1212',105),(44040,'标准间','一楼',2121,'1212',106);
...
-- Dump completed on 2019-12-16 11:13:36
